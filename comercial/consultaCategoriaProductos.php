<?php
    ...
    <head>
        ...
        <title>Consulta categoria productos</title>
    ...
    <body>
        ...
        <div class="alert alert-secondary">
            <div class="page-wrapper bg-secondary p-b-100 pt-2 font-robo">
                <div class="wrapper wrapper--w680"><div style="color:white; text-align:center"><h6>Consulta Categoría Productos</h6></div>
                    <div class="card card-1">
                        <div id="username" hidden><?= $_SESSION['username'] ?></div>

                        <div class="row" style="margin-left:80px">
                            <h3><i class="bi bi-wrench-adjustable" style="margin-right:10px;font-size:50px"></i>Consulta Categoría Productos - <?= $descRubro ?></h3>
                        </div>
                        <form action="">
                            <div  class="row" style="margin-left:80px">
