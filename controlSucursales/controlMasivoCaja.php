                        ...
                        <table class="table table-striped table-bordered table-sm table-hover" id="tablaControl" style="width: 95%; height:100px; margin-left:50px" cellspacing="0" data-page-length="100">
                            ...
                            ?>
                                    ...
                                    <tr>
                                        ...
                                        <?php
                                            $negativo = "";
                                            if($importe['IMPORTE_$_FISICO'] < 0){
                                                $importe['IMPORTE_$_FISICO'] = $importe['IMPORTE_$_FISICO']*-1;
                                                $negativo = "-";

                                            }
                                        ?>
                                        <td style="text-align:center"><input type="text" style="text-align:center;width:100%" onchange="calcularDiferecias(this)" id="valorFisico" value="<?= $negativo ?>$<?= number_format($importe['IMPORTE_$_FISICO'], 0, ',', '.') ?>" <?= ($importe['VERIFICADO'] == 1) ? "disabled" : "" ?>></td>
