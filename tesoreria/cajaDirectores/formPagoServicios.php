    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-12 px-3 px-md-4"
                style="padding-top: calc(var(--navbar-height, 56px)); padding-bottom: 1rem;">
                <div
                    ...
                    <div class="btn-toolbar">
                        <button type="button" class="btn btn-sm btn-outline-secondary">
                            <i class="bi bi-calendar3"></i> <span
                                class="d-none d-sm-inline"><?php echo date('d/m/Y'); ?></span>
                        </button>
                    </div>
                </div>
                                ...
                                <form id="formPagoServicios">
                                        ...
                                        <div class="card border-info">
                                            ...
                                            <div class="card-body">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="form-text">
                                                        Busque por nombre o CUIT del proveedor. Escriba al menos 2
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="cbuProveedor"
                                                        placeholder="22 dígitos (opcional)" maxlength="22"
                                                        pattern="\d{22}">
                                                    <div class="form-text">
                                                        CBU de 22 dígitos (opcional - se completará automáticamente si
                                                        el proveedor lo tiene cargado)
                                                    </div>
                                                    <div id="alertaCBU" class="alert alert-info d-none mt-2">
                                                        <i class="bi bi-info-circle"></i>
                                                        <strong>Información:</strong> Este proveedor aún no tiene CBU
                                                        cargado en la base. Puede completarlo si lo conoce.
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-0">
                                                    ...
                                                    <div class="form-text">
                                                        Descripción de la cuenta (opcional, se completará
                                                        automáticamente si el proveedor la tiene cargada)
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control importe-input" id="importePago"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="d-md-none mb-2">
                                            <div class="btn-group w-100" role="group">
                                                <input type="file" class="d-none" id="facturaCamera" accept="image/*"
                                        ...
                                        <div class="form-text">
                                            <small>
                                                <strong>Móvil:</strong> <span class="text-primary">Cámara</span> abre
                                                directamente la cámara | <span class="text-secondary">Galería</span>
                                                permite elegir imagen o PDF guardado<br>
                                                <strong>Escritorio:</strong> Seleccione uno o más archivos JPG, PNG o
                                                PDF<br>
