    ...
    <div class="row mb-4">
        ...
        <div class="col-lg-3 col-md-6 mb-4">
            <div class="card shadow-sm border-left-danger h-100">
                <div class="card-body">
                    <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">Deuda Pendiente (Fuera de
                        Propuesta)</div>
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <h5 class="mb-3 border-bottom pb-2"><i class="fa-solid fa-money-bill-1 fa-1x"></i> Propuestas de
                        Pago </h5>
                ...
                <div class="col-lg-4 border-start ps-lg-4">
                    <h5 class="mb-3 border-bottom pb-2"><i class="fa-solid fa-calendar-days me-2"></i>Cronograma de
                        Pagos</h5>
