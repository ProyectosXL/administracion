...
/**
 * Clase Proveedor
 * Gestiona consultas de proveedores desde la tabla CPA01 en base LAKER_SA (Host CENTRAL)
 */
class Proveedor {
    private $dbCentral;
    private $conexion;
    ...
    public function obtenerPorNombre($nombreProvee) {
        try {
            ...
            if ($stmt === false) {
                throw new Exception("Error al obtener proveedor: " . print_r(sqlsrv_errors(), true));
            }
