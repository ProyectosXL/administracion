...
function addRow(tableDinamic) {
    ...
    function guardarGasto(){
      ...
      let cuenta = document.querySelector(".cuenta").textContent.replace(/(\r\n|\n|\r)/gm, "");
      arreglo.push(cuenta);
      ...
      let rubro = document.querySelector(".rubro").textContent.replace(/(\r\n|\n|\r)/gm, "");
      arreglo.push(rubro);
      let codProrrateo = document.querySelector(".codProrrateo").value;
      arreglo.push(codProrrateo);
      let descProrrateo = document.querySelector(".descProrrateo").textContent.replace(/(\r\n|\n|\r)/gm, "");
      ...
      if(fecha != '' && codCentro != '' && codCuenta != '' && importe != '' && leyenda != '' && codRubro != '' && codProrrateo != ''){
          Swal.fire({
              icon: 'info',
              ...
              if (result.isConfirmed) {
                console.log('EH');
                  ...
                  Swal.fire('Gasto cargado correctamente!', '', 'success')
                      .then(function () {
                        window.history.back();;
                  });
              } else if (result.isDenied) {
                  Swal.fire('El gasto no fue cargado', '', 'info')
                  .then(function () {
