                                    ...
                                    <div class="col"  style="height:500px">
                                        <div class="mt-1" style="width:100%;height:125%;border:1px solid grey; border-radius: 8px;">
                                            ...
                                            <div class="row ml-2 mt-3" style="width:98%;">
                                                ...
                                                <div class="col-3 mr-1 inputOverflow" style="background-color:#dbdbdb;height:45px;font-size:12px;text-align:left" id="fechaIngreso"><span style="color:#969396">Fecha de ingreso </span> <br> <span style="margin-left:30%;margin-top:10%"></span></div>
                                            </div>
