                    ...
                    <div class="card card-1">
                        ...
                        <div class="inline-container" style="margin-left:50px;width: 60%; display: inline-block;">
                                <div id="" style="display: inline-block;margin-left:60%">
                                        <input type="checkbox" style="width: 16px;height: 16px;"> Todos
                                </div>
                        ...
                        <table class="table table-striped table-bordered table-sm table-hover" id="tablaVendedores" style="width: 60%; height:100px; margin-left:50px" cellspacing="0" data-page-length="100">
