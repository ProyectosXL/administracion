...
class Horario
{
    ...
    public function traerSucursales () {
            ...
            UNION ALL
            SELECT NRO_SUCURSAL, DESC_SUCURSAL, COD_CLIENT FROM LAKERBIS.LOCALES_LAKERS.DBO.SUCURSALES_LAKERS WHERE NRO_SUCURSAL = '16' ORDER BY  DESC_SUCURSAL";
    ...
    public function crearEmpleado($stringParaSql, $legajo) {
        ...
        INSERT INTO RO_T_LEGAJOS_PERSONAL (NRO_LEGAJO,NRO_DOCUMENTO, APELLIDO, NOMBRE, COD_VENDEDOR, DOMICILIO, PISO, DEPTO, PAIS, LOCALIDAD, CODIGO_POSTAL,NUM_SUCURSAL ,TAREA_HABITUAL , TIPO_CONTRATO, FECHA_INGRESO,EMAIL,TELEFONO, TELEFONO2, HABILITADO, CONTRASEÑA) VALUES $cadenaFinal";
